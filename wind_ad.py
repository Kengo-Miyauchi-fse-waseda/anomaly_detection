...
from util_module.callback import set_log
...
train_range = ('2017-01-01T00:00:00+00:00','2017-04-30T23:50:00+00:00')
train = utils.extract_specific_terms(data,train_range[0],train_range[1])
valid = utils.extract_specific_terms(data,'2017-05-01T00:00:00+00:00','2017-05-14T23:50:00+00:00')
